...
//라이브러리
include_once $GP -> INC_ADM."/lib/gabia_xmlrpccommon.php";
include_once $GP -> INC_ADM."/lib/xml_helper.php";
...
DOC_XML;
	...
	public function sms_send($phone, $callback, $msg, $refkey="", $reserve = "0")
	{
