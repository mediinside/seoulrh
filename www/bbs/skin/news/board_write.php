	...
	<div class="txtR"><span>*</span> 필수입력</div>
      ...
      <tbody>
        ...
        <tr>
          ...
          <td><input type="text" class="i-input" title="SNS 링크 입력" placeholder="SNS 링크를 입력해 주세요."id="jb_etc2" name="jb_etc2"  />
        </td>
        </tr> 
        <tr>
          <th scope="row">해시태그</th>
          <td><input type="text" class="i-input" title="해시태그 입력" placeholder="해시태그를 입력해 주세요."id="jb_etc1" name="jb_etc1"  />
                ex) #서울재활병원 #병원소식
        </td>
        </tr>     
        <?php
        ...
        <tr>
          ...
          <td class="files">
			...
			//첨부파일의 숫자는 $i의 범위로 조정하면 된다.
				for($i=0; $i<1; $i++) {
	    	?>
				<input type="file" name="jb_file[]" class="fileInput"> (448 X 215)
			<? } ?>
          </td>
        </tr>
        <tr>
