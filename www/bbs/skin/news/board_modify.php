  ...
  <div class="subttile">
    ...
    <div class="tbl-type3 resev">
      ...
      <tbody>
        ...
        <tr>
          <th scope="row">SNS</th>
          <td><? echo $news_select = $C_Func -> makeSelect_Normal('jb_type', $GP -> SNS_TYPE, $jb_type, '', '::선택::');?></td>
        </tr>
        <tr>
          <th scope="row">SNS 링크</th>
          <td><input type="text" class="i-input" title="SNS 링크 입력" placeholder="SNS 링크를 입력해 주세요."id="jb_etc2" name="jb_etc2"  value="<?=$jb_etc2?>"/>
        </td>
        </tr> 
        <tr>
          <th scope="row">해시태그</th>
          <td><input type="text" class="i-input" title="해시태그 입력" placeholder="해시태그를 입력해 주세요."id="jb_etc1" name="jb_etc1" value="<?=$jb_etc1?>" />
                ex) #서울재활병원 #병원소식
        </td>
        <tr>
          ...
          <td class="files"> 
            ...
            ?>						
                 <span class="inputFile">
                  <input type="text" class="txt" placeholder="첨부파일" readonly />(450 X 216)
                  <span class="fileBtn">
