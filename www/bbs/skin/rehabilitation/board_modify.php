    ...
    <div class="tbl-type3 resev">
      ...
      <tbody>
        ...
        <!--tr>
          ...
          <td><input type="text" class="i-input" title="유튜브 링크 입력" placeholder="유튜브 링크를 입력해 주세요."id="jb_etc2" name="jb_etc2"  value="<?=$jb_etc2?>"/>
            ex) https://www.youtube.com/embed/fa-URCbJm4A 
        </td-->      
        <tr>
          <th scope="row"> 설명</th>
          <td><input type="text" class="i-input" title="설명 입력" placeholder="설명을 입력해 주세요."id="jb_etc1" name="jb_etc1" value="<?=$jb_etc1?>" />
        </td>
        <tr>
          ...
          <td class="files"> 
            ...
            ?>						
                 <span class="inputFile">
                  ...
                  <span class="fileBtn">
                    <input type="file" title="파일선택" name="jb_file[]" />(450 X 290)
