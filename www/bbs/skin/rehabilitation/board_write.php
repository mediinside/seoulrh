 ...
 <div class="tbl-type3 resev">
	<div class="txtR"><span>*</span> 필수입력</div>
      ...
      <tbody>
        ...
        <!--tr>
          <th scope="row">유튜브 링크</th>
          <td><input type="text" class="i-input" title="유튜브 링크 입력" placeholder="유튜브 링크를 입력해 주세요."id="jb_etc2" name="jb_etc2"  />
            ex) https://www.youtube.com/embed/fa-URCbJm4A 
        </td-->
        <tr>
          <th scope="row">설명</th>
          <td><input type="text" class="i-input" title="설명 입력" placeholder="설명을 입력해 주세요."id="jb_etc1" name="jb_etc1"  />
