...
if($data_list_cnt > 0) {
	for ($i=0; $i<$data_list_cnt; $i++ ) {
            ...
            $jb_title					=  trim(strip_tags($jb_title));
			...
			//타이틀이미지
			$new_image = '<div class="new" style="display:inline-block;"></div>';
			$new_icon = $C_Func->new_icon2(1, $data_list[$i]['jb_etc2'], $new_image);
			//파일 이미지
            ...
            $img_src = '';
			if($jb_file_code != '') {
				$code_file = "/bbs/files/jb_${jb_code}/${jb_file_code}";
                ...
                <a href='" . $link . "' target='_blank'>
                    <div class='dec'>
                        ...
                        <span class='txt'>
							...
							<br>
							<small class='date'> ${jb_etc2}</small>
						</span>
                    </div>
                </a>
            </li>
