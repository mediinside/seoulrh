    ...
    <div class="tbl-type3 resev">
      ...
      <tbody>
        ...
        <tr>
            <th>등록일</th>
            <td>
            <input type="text" class="i-inputpop " size="15" name="jb_etc2" id="jb_etc2" value="<?=$jb_etc2?>"/>								
            </td>
        </tr>
        <tr>
          <th scope="row">SNS 링크</th>
          <td><input type="text" class="i-input" title="SNS 링크 입력" placeholder="SNS 링크를 입력해 주세요."id="jb_etc3" name="jb_etc3"  value="<?=$jb_etc3?>"/>
        </td>
        </tr>      
        <tr>
          ...
          <td class="files"> 
            ...
            ?>						
                 <span class="inputFile">
                  <input type="text" class="txt" placeholder="첨부파일" readonly />(450 X 290)
                  <span class="fileBtn">
