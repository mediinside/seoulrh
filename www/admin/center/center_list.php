...
<div class="Wrap"><!--// 전체를 감싸는 Wrap -->
		...
		<button onClick="layerPop('ifm_reg','./center_reg.php', '100%', 650)"; class="btnSearch ">조직운영안내 등록</button>
		</div>
							...
							<?
								...
								if($data_list_cnt > 0 ) {
									for ($i = 0 ; $i < $data_list_cnt ; $i++) {
										...
										$edit_btn = $C_Button -> getButtonDesign('type2','수정',0,"layerPop('ifm_reg','./center_edit.php?s_idx=" . $s_idx. "', '100%', 650)", 50,'');	
