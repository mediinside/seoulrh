					...
					<table class="table table-bordered">
						<tbody>                                         
                            <tr>
								<th><span>*</span>부서명</th>
								<td>
									<input type="text" class="input_text" size="150" name="s_content1" id="s_content1" value="<?=$s_content1?>"/>
								</td>
                            </tr>	
                            <tr>
								<th><span>*</span>이름</th>
								<td>
									<input type="text" class="input_text" size="150" name="s_content2" id="s_content2" value="<?=$s_content2?>"/>
								</td>
                            </tr>
                            <tr>
								<th><span>*</span>직종</th>
								<td>
									<input type="text" class="input_text" size="150" name="s_content3" id="s_content3" value="<?=$s_content3?>"/>
								</td>
                            </tr>
                            <tr>
								<th><span>*</span>담당업무</th>
								<td>
									<input type="text" class="input_text" size="150" name="s_content4" id="s_content4" value="<?=$s_content4?>"/>
								</td>
                            </tr>
                            <tr>
								<th><span>*</span>부서전화번호</th>
								<td>
									<input type="text" class="input_text" size="150" name="s_content5" id="s_content5" value="<?=$s_content5?>"/>
								</td>
                            </tr>                           
							<tr>
