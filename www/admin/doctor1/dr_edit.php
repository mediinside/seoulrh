...
<div class="Wrap_layer"><!--// 전체를 감싸는 Wrap -->
	<div class="boxContent_layer">
        ...
        <input type="hidden" name="dr_menu" id="dr_menu" value="Z" />
			...
			<div class="layerTable">
            	...
            	<tr>
						...
						<tr>
							...
							<td>
								<table>
									...
									<!--tr>
										<td>비고</td>
										<td colspan="6"><input type="text" class="input_text" size="120" name="dr_history4" id="dr_history4" value="<?=$dr_history4?>" /></td>
									</tr-->
								</table>
							</td>
						</tr>
						...
						<tr>
							...
							<td>
								<input type="file" name="dr_face_img" id="dr_face_img" size="30">(442 X 533)
								<?
									if($dr_face_img != "") {
										echo  "<br>" . $dr_face_img;
								?>
