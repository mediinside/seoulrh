...
<div class="Wrap"><!--// 전체를 감싸는 Wrap -->
		...
		<div class="btnWrap" style="display: none;">
			...
			<button onClick="layerPop('ifm_reg','./dr_reg.php', '100%', 600)"; class="btnSearch btnRight">진료과 등록</button>
		</div>
						...
						<tbody>
							...
							<?
								...
								for ($i = 0 ; $i < $data_list_cnt ; $i++) {
									...
									$dr_img = '';
									if($dr_face_img !=  '') {
										$dr_img = "<img src='" . $GP -> UP_CLINIC_URL . $dr_face_img . "' width='100px' />";
									}

									$dr_img1 = '';
									if($dr_list_img !=  '') {
										$dr_img1 = "<img src='" . $GP -> UP_CLINIC_URL . $dr_list_img . "' width='100px' />";
									}

									$dr_img2 = '';
									if($dr_m_list_img !=  '') {
										$dr_img2 = "<img src='" . $GP -> UP_CLINIC_URL . $dr_m_list_img . "' width='100px' />";
									}

									$dr_img3 = '';
									if($dr_vod_thum_img !=  '') {
										$dr_img3 = "<img src='" . $GP -> UP_CLINIC_URL . $dr_vod_thum_img . "' width='100px' />";
									}
...
<script type="text/javascript">
	...
	$(document).ready(function(){																 
		...
		var cl_id = "";
		var ch_id = "";
		$(".boxMemberBoard1 tbody").sortable({
			helper: fixHelper,
