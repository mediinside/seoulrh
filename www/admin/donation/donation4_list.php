...
<div class="Wrap"><!--// 전체를 감싸는 Wrap -->
		...
		<button onClick="layerPop('ifm_reg','./donation4_reg.php', '100%', 650)"; class="btnSearch ">직원헌금 등록</button>
		</div>
							...
							<?
								...
								if($data_list_cnt > 0 ) {
									for ($i = 0 ; $i < $data_list_cnt ; $i++) {
										...
										$edit_btn = $C_Button -> getButtonDesign('type2','수정',0,"layerPop('ifm_reg','./donation4_edit.php?do_idx=" . $do_idx. "', '100%', 650)", 50,'');	
										$edit_btn .= $C_Button -> getButtonDesign('type2','삭제',0,"donation4_delete('" . $do_idx. "')", 50,'');
								?>
									<tr>
...
<script type="text/javascript">
	...
	function donation4_delete(do_idx)
	{
