...
//ini_set("display_errors", 1);
	...
	$rst = $C_donation ->donation2_Info($args);
...
<div class="Wrap_layer"><!--// 전체를 감싸는 Wrap -->
	<div class="boxContent_layer">
		<div class="boxContentHeader">
			<span class="boxTopNav"><strong>후원금 수정</strong></span>
		</div>
		<form name="base_form" id="base_form" method="POST" action="?" enctype="multipart/form-data">
		<input type="hidden" name="mode" id="mode" value="donation2_MODI" />
				...
				<div class="layerTable">
					<table class="table table-bordered">
                        ...
                        <tr>
								<th><span>*</span>년도</th>
								<td>
                                    <input type="text" class="input_text" size="30" name="do_year" id="do_year" onKeyup="this.value=this.value.replace(/[^0-9]/g,'');" value="<?=$do_year?>"/>년      &nbsp;※숫자만 입력해 주세요.
							...
							<tr>
								<th><span>*</span>구분</th>
								<td>
									<input type="text" class="input_text" size="30" name="do_gubun" id="do_gubun" value="<?=$do_gubun?>"/>
								</td>
                            </tr>	
                            <tr>
								<th><span>*</span>금액</th>
								<td>
									<input type="text" class="input_text" size="30" name="do_pay" id="do_pay" value="<?=$do_pay?>"/>
								</td>
							</tr>	
							<tr>
...
<script type="text/javascript">
	...
	function img_del(image, idx, type)
	{
		...
		$.ajax({
			...
			data: "mode=donation2_IMGDEL&do_idx=" + idx + "&file=" + image + "&type=" + type,
			dataType: "text",
