...
<div class="Wrap_layer"><!--// 전체를 감싸는 Wrap -->
	<div class="boxContent_layer">
		<div class="boxContentHeader">
			<span class="boxTopNav"><strong>퀵 배너 슬아이드 수정</strong></span>
		</div>
        ...
        <input type="hidden" name="ts_type" id="ts_type" value="Q" />
				...
				<div class="layerTable">
					<table class="table table-bordered">
						<tbody>													          							
							...
							<th><span>*</span>이미지</th>
							<td>                               
								<input type="file" name="ts_img" id="ts_img" size="30"><span id="size_pc"></span>(100 X 100)                               
								<?
									if($ts_img != "") {
										echo  "<br>" . $ts_img;
								?>
