<?php
	...
	$slide_select = $C_Func -> makeSelect_Normal('ts_type', $GP -> SLIDE_position, $ts_type, '', '::선택::');	
?>
<body>
<div class="Wrap_layer"><!--// 전체를 감싸는 Wrap -->
	<div class="boxContent_layer">
		<div class="boxContentHeader">
			<span class="boxTopNav"><strong>메인 탑 배너 수정</strong></span>
		</div>
        ...
        <input type="hidden" name="ts_lang" id="ts_lang" value="kor" />
        <input type="hidden" name="ts_type" id="ts_type" value="B" />
				...
				<div class="layerTable">
					<table class="table table-bordered">
						<tbody>													          							
							...
							<th><span>*</span>이미지</th>
							<td>
                                 전체 이미지 사이즈 : 1900 X 140<br>
                                전체 이미지 사이즈 내 내용물 사이즈 : 1060 X 140<br>
								<input type="file" name="ts_img" id="ts_img" size="30"><span id="size_pc"></span>
						...
						<!--tr id="mobile_img">
							...
							<td>
								<input type="file" name="ts_m_img" id="ts_m_img" size="30"><span id="size_m"></span>
								<?
									if($ts_m_img != "") {
										echo  "<br>" . $ts_m_img;
								?>
