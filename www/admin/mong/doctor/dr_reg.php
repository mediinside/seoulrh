<?php
	...
	$cn_chk1 = $C_Func -> makeCheckbox_Normal($GP -> DOCTOR_POSITION, 'dr_position[]', $dr_position, '', '300');
?>
<body>
<div class="Wrap_layer"><!--// 전체를 감싸는 Wrap -->
	<div class="boxContent_layer">
        ...
        <input type="hidden" name="dr_lang" value="<?=$lang?>" />
