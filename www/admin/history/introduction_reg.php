...
<div class="Wrap_layer"><!--// 전체를 감싸는 Wrap -->
	<div class="boxContent_layer">
		<div class="boxContentHeader">
			<span class="boxTopNav"><strong>병원소개 등록</strong></span>
		</div>
		<form name="base_form" id="base_form" method="POST" action="?" enctype="multipart/form-data">
        <input type="hidden" name="mode" id="mode" value="COOPERATIVE_REG" />
        <input type="hidden" name="cate1" id="cate1" value="A" />
				...
				<div class="layerTable">
					<table class="table table-bordered">
						<tbody>							
                            ...
                            <tr>	
								<th><span>*</span>썸네일</th>
								<td><input type="file" name="cp_img" id="cp_img" size="30">인증로고 사이즈 : 가로 상관없이 높이만 48px로 맞춰서 넣어 주세요.</td>
                            </tr>	  
                            <tr>	
								<th><span>*</span>링크</th>
