...
$(function() {
    swfu = new SWFUpload({
    	flash_url: rt_path +'/src/js/swfu/swfupload.swf',
    	upload_url: rt_path +'/inc/swfupload',
    	post_params: {
            'PHPSESSID'  : phpsessid,
    	...
    	file_upload_limit: typeof(file_upload_limit) != 'undefined' ? file_upload_limit : 20,
    	file_queue_limit: 0,
    	custom_settings: {
    	...
    	button_text_style: '.button { font-family:돋움; font-size:11pt; } .buttonSmall { font-size:10pt; }',
