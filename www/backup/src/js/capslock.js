if (typeof(CAPSLOCK_JS) == 'undefined') {
    ...
    function set_capslock_info_position(elem_id) {
        ...
        var ref = (typeof elem_id != 'object') ? document.getElementById(elem_id) : elem_id;
    ...
    $(document).ready(function() {
    	$('#show_capslock').html("<div id='capslock_info' style='display:none; position:absolute;'><img src='"+rt_path+"/src/imgs/js/capslock.gif'></div>");
    });
}