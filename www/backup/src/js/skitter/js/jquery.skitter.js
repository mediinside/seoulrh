...
(function($) {
	...
	$.fn.jumpToVisual = function(sk_no, img_no) {
		if (skitters[sk_no].settings.is_animating != false) {
			return false;
		}
		skitters[sk_no].jumpToImage(img_no);
		return true;
	};
	...
	$sk.fn.extend({
		...
		setup: function() 
		{
			...
			if (this.settings.fullscreen) {
				...
				this.box_skitter.css({'position':'absolute', 'top':0, 'left':0, 'z-index':99});
		...
		focusSkitter: function() {
			...
			self.box_skitter.find('.focus_button').click(function() {
				...
				self.box_skitter
					.css({'top':_top, 'left':_left, 'position':'absolute', 'z-index':98})
