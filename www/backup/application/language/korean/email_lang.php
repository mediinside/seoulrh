...
$lang['email_must_be_array'] = "이메일 검증은 반드시 배열로 전달해야 합니다.";
$lang['email_invalid_address'] = "이메일 형식이 틀립니다: %s";
$lang['email_attachment_missing'] = "다음 메일의 첨부 파일을 찾을 수 없습니다: %s";
$lang['email_attachment_unreadable'] = "다음의 첨부 파일을 열수 없습니다: %s";
$lang['email_no_recipients'] = "대상(To, Cc, Bcc)이 지정되어 있지 않습니다.";
...
$lang['email_no_socket'] = "Sendmail 소켓을 열 수 없습니다. 설정파일을 확인하시기 바랍니다.";
$lang['email_no_hostname'] = "SMTP 호스트 이름이 지정되어 있지 않습니다.";
$lang['email_smtp_error'] = "다음 SMTP 오류가 발생하였습니다: %s";
$lang['email_no_smtp_unpw'] = "오류 : SMTP 사용자 이름과 암호를 지정해야 합니다.";
$lang['email_failed_smtp_login'] = "AUTH LOGIN 명령을 보내는데 실패하였습니다. 오류: %s";
$lang['email_smtp_auth_un'] = "아이디 인증이 실패하였습니다. 오류: %s";
$lang['email_smtp_auth_pw'] = "암호 인증에 실패하였습니다. 오류: %s";
