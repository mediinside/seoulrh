...
class Profile extends CI_Controller {
	...
	function qry($mb_id) {
		...
		$mb = $this->M_basic->get_member($mb_id, "mb_id, mb_level, mb_point, mb_homepage, mb_open, mb_nick, mb_datetime, mb_today_login, mb_profile");
		if (!isset($mb['mb_id']))
		...
		$vars = array(
			'_TITLE_'		=> $mb['mb_nick'].'님의 자기소개',
			'_BODY_'		=> 'member/profile',
			'_CSS_'			=> array('profile'),
