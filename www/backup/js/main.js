...
/*
	...
	*/
	...
	function nowFn(){
		...
		menu.eq(0).animate({left:(moveP*-1)+470}, 200, 'easeInOutExpo')
		menu.eq(1).animate({left:(moveP*-1)+492}, 200, 'easeInOutExpo')
		menu.eq(2).animate({left:(moveP*-1)+514}, 200, 'easeInOutExpo')
	}
}
